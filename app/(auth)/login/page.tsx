    ...
    >
      ...
      <div className="hidden lg:flex flex-1 flex-col items-center justify-center p-12 text-white">
        ...
        <p className="text-blue-200 text-center max-w-sm text-sm leading-relaxed">
          Gerencie a conformidade da sua empresa com a Lei Geral de Proteção de Dados de forma
          simples e segura.
        </p>
        <div className="mt-10 grid grid-cols-2 gap-4 w-full max-w-xs">
          {['Inventário de Dados', 'Treinamentos', 'Canal de Denúncias', 'Logs Jurídicos'].map(
            (f) => (
        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <Card className="shadow-2xl border-0">
            <CardHeader className="pb-4">
              <CardTitle className="text-xl" style={{ color: '#0f2d5e' }}>
