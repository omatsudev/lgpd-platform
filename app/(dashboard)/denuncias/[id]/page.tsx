      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-sm">
          <div className="grid grid-cols-2 gap-4">
            <div><span className="text-gray-500">Tipo:</span> <span className="font-medium ml-1">{denuncia.type}</span></div>
            <div>
            ...
            {denuncia.source_ip && (
              <div><span className="text-gray-500">IP de origem:</span> <span className="font-mono ml-1 text-xs">{denuncia.source_ip}</span></div>
            )}
          </div>
          <div className="pt-2">
          ...
          {denuncia.response && (
            <div className="pt-2">
              ...
              <p className="text-gray-800 bg-green-50 p-3 rounded-lg border border-green-100">{denuncia.response}</p>
            </div>
          )}
        </CardContent>
      </Card>
        ...
        <CardContent>
          <form action={atualizarDenuncia} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea name="response" defaultValue={denuncia.response ?? ''} rows={4} placeholder="Registre as ações tomadas, investigações realizadas..." />
            </div>
