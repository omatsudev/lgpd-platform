    ...
    <div className="space-y-5">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Identificação, avaliação e tratamento de riscos LGPD</p>
        </div>
        <Link href="/riscos/novo">
      ...
      {aba === 'matriz' ? (
        ...
        <Card>
          <CardHeader className="pb-3">
            <SearchInput defaultValue={q ?? ''} placeholder="Buscar por título, categoria, responsável..." />
          </CardHeader>
          <CardContent className="p-0">
            {itens.length === 0 ? (
              <div className="py-12 text-center">
                ...
                <p className="text-sm text-gray-400 mt-1">Registre e acompanhe os riscos identificados</p>
              </div>
            ) : (
              <>
                {/* Desktop */}
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-gray-200 bg-gray-50">
                        ...
                        <th className="text-left py-3 px-4 text-xs font-semibold text-gray-500 uppercase">Inerente</th>
                        <th className="text-left py-3 px-4 text-xs font-semibold text-gray-500 uppercase">Residual</th>
                        <th className="text-left py-3 px-4 text-xs font-semibold text-gray-500 uppercase">Estratégia</th>
                            ...
                            <td className="py-3 px-4">
                              {residual ? (
                                <div className="flex items-center gap-1.5">
                                  ...
                                  <Badge variant={residual.variant} className="text-xs">{residual.label}</Badge>
                                </div>
