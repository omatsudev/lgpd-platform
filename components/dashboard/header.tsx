  ...
  return (
    <header className="sticky top-0 z-40 flex h-16 items-center gap-4 border-b border-gray-200 bg-white px-6 shadow-sm">
      <div className="flex items-center gap-2 text-sm text-gray-600">
        <Building2 className="h-4 w-4" style={{ color: '#0f2d5e' }} />
        <span className="font-semibold" style={{ color: '#0f2d5e' }}>{empresaNome}</span>
      </div>
      ...
      <div className="ml-auto flex items-center gap-3">
        ...
        <button className="flex items-center gap-2 rounded-lg px-3 py-1.5 text-sm font-medium text-gray-700 hover:bg-gray-100 transition-colors">
          <div className="h-7 w-7 rounded-full flex items-center justify-center text-white text-xs font-bold" style={{ background: 'linear-gradient(135deg, #0f2d5e, #00bcd4)' }}>
